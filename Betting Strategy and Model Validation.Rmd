...
author: "[Ryo®, Eng Lian Hu](http://englianhu.wordpress.com) <img src='figure/TonyStark.png' width='24'> TonyStark®"
date: "7/22/2015"
output:
  html_document:
    css: custom.css
...
pkgs <- c('devtools','zoo','chron','stringr','stringi','reshape','reshape2','data.table','sparkline','DT','plyr','dplyr','magrittr','foreach','manipulate','ggplot2','ggthemes','proto','extrafont','directlabels','PerformanceAnalytics','plotly','doParallel','rvest','highlightHTML','knitr','rmarkdown','scales','lubridate','tidyr','whisker','gtable','grid','gridExtra','pander')
